...
class Player:
    def __init__(self, x, y):
        ...
        mask_rect = mask.get_rect()  # Lấy Rect từ mask
        
        # Khởi tạo rect dựa trên kích thước mask_rect, đặt tại (x, y)
        self.rect = pygame.Rect(x, y, mask_rect.width, mask_rect.height)
    ...
    def update_hitbox(self):
        if self.is_attacking:
            tongue_length = 30  # Độ dài lưỡi, điều chỉnh theo sprite attack
            hitbox_height = 20
            if self.direction == 1:
    ...
    def draw(self, surface):
        ...
        offset_y = sprite_size[1] - self.rect.height
        ...
        pygame.draw.rect(surface, (0, 0, 255), self.hitbox, 2)